...
const Contact = () => {
  return (
    <section id="contact" className="relative min-h-screen scroll-mt-20 pb-28 pt-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl border border-overlay/10 bg-surface p-4">
            <CalComWidget />
          </div>
